      ...
      <div class="card">
        ...
        <div class="space-y-3">
          <div>
            ...
            <input v-model="formatDateInput" type="date" class="input" />
          </div>
          <div>
      ...
      <div class="card">
        ...
        <div class="space-y-3">
          <div>
            ...
            <input v-model="timeAgoInput" type="datetime-local" class="input" />
          </div>
      ...
      <div class="card">
        ...
        <div class="space-y-3">
          <div>
            ...
            <input v-model="isValidDateInput" type="text" placeholder="e.g., 2024-01-15, invalid, 1234567890"
              class="input" />
          </div>
          <div class="result-box">
...
const formatDateResult = computed(() => {
  if (!formatDateInput.value) return 'Invalid date';
  try {
