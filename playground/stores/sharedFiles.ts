...
export const useSharedFiles = defineStore('sharedFiles', () => {
  ...
  const APP_IMG = `${SHARED_URL}/AXIOM`;

  // Chemins des fichiers
  const paths = {
    // IMAGES
    logo: {
      dc: `${GNR_IMG}/Logos/AXIOM-DC.png`,
      dw: `${GNR_IMG}/Logos/AXIOM-DW.png`,
      mc: `${GNR_IMG}/Logos/AXIOM-MC.png`,
      mw: `${GNR_IMG}/Logos/AXIOM-MW.png`,
